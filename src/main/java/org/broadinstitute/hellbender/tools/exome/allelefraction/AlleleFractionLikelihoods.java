...
public final class AlleleFractionLikelihoods {
     ...
     */
    public static double hetLogLikelihood(final AllelicBiasParameters parameters, final double minorFraction, final AllelicCount count, final AlleleFractionIndicator indicator) {
     ...
     */
    public static double hetLogLikelihood(final AllelicBiasParameters parameters, final double minorFraction,
     ...
     */
    public static double collapsedHetLogLikelihood(final AllelicBiasParameters parameters, final double minorFraction,
     ...
     */
    public static double segmentLogLikelihood(final AllelicBiasParameters parameters, final double minorFraction,
     ...
     */
    public static double logLikelihood(final AllelicBiasParameters parameters, final AlleleFractionState.MinorFractions minorFractions,
